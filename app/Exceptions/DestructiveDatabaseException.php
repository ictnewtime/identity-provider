 ...
 *
 * Perche' esiste: prima qui c'era `RuntimeException`, che e' la classe di **qualunque**
 ...
 *
 * Estende `RuntimeException` di proposito: e' un guasto d'ambiente scoperto
 ...
 *
 * **Una per modulo, non una per causa**: la guardia rifiuta per due ragioni —
