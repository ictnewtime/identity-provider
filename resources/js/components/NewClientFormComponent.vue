                ...
                <form v-on:submit.prevent="" class="col-12">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="client-name"
                            type="text"
                            :class="'form-control col-sm-12 col-md-8 col-lg-6' + (!validator.name ? ' is-invalid' : '')"
                            name="client-name"
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            type="text"
                            :class="
                                'form-control col-sm-12 col-md-8 col-lg-6' +
                                (!validator.redirectURL ? ' is-invalid' : '')
                            "
                            name="redirectURL"
                            placeholder="Inserisci una rotta di callback"
                        />
                    </div>
                    <div class="d-flex">
                        <button class="btn btn-primary confirm-button mt-2" @click="createClient" :disabled="loading">
                            Crea client
                        </button>
                        <p v-show="loading" class="align-self-end m-0 ml-2">
                            <i class="fas fa-spinner fa-pulse mr-2"></i>Elaborazione in corso...
                        </p>
                    </div>
                </form>
            </div>
...
export default {
    ...
    methods: {
        ...
        exportCSVFile(jsonObject) {
            ...
            var headers = ["id", "name", "secret", "redirect"];
