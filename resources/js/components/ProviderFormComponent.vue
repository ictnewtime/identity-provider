        ...
        <div class="form-row">
          <div class="form-group col-lg-6">
            ...
            <input
              type="text"
              v-bind:class="
                'form-control ' + (!validator.domain ? 'is-invalid' : '')
              "
              id="input-domain"
          ...
          <div class="form-group col-lg-6">
            ...
            <input
              ...
              :placeholder="
                'https://' +
                (form.domain ? form.domain : 'dominio') +
                '/logout-idp'
              "
              name="logoutUrl"
        ...
        <div class="form-row">
          <div class="form-group col-lg-6">
            ...
            <input
              type="text"
              :class="
                'form-control ' + (!validator.username ? 'is-invalid' : '')
              "
              id="input-username"
          ...
          <div class="form-group col-lg-6">
            ...
            <input
              type="password"
              :class="
                'form-control ' + (!validator.password ? 'is-invalid' : '')
              "
              id="input-password"
              placeholder="Secret"
              name="password"
    ...
    submit: function () {
      ...
      axios
        ...
        .catch(function (error) {
          EventBus.$emit("newNotification", {
            message:
              "Dominio esistente o errore durante la registrazione del provider.",
            type: "ERROR",
          });
        });
    },
