...
| [./todo/20260820-security-reliability/](./todo/20260820-security-reliability/) | Sei rilievi di sicurezza e affidabilità. Uno **ha già fatto danno**: i container dei test scrivono come root, e nell'albero ci sono **3996 file di root** — uno dei quali blocca `npm run build` (`BDB32`, causa finalmente nota). Un altro è un falso positivo che nasconde il difetto opposto | `TSR` | media |
| [./todo/20260821-exceptions-and-waits/](./todo/20260821-exceptions-and-waits/) | Sei rilievi di SonarQube di severita' media: quattro `RuntimeException` generiche dove servirebbe un nome — nel guardiano del database e nel seeder — un ternario annidato nel codice che decide «deleted» o «restored» negli audit, e due `cy.wait(500)` che **coincidono col debounce della ricerca**: attese fisse che passano o falliscono secondo quanto e' carica la macchina | `TEW` | bassa |
