...
| [./todo/20260819-audit-complexity/](./todo/20260819-audit-complexity/) | `logAudit()` — 95 righe che scrivono la traccia di chi ha fatto cosa, su sei modelli — più due rilievi minori. A differenza del frontend, qui **PHPUnit c'è**: la rete si può stendere prima di toccare | `TAC` | media |
...
| [./todo/20260819-translation-coverage/](./todo/20260819-translation-coverage/) | Due dialoghi mostrano all'utente la **chiave** di traduzione invece del testo (`VDF23`), e il controllo che l'avrebbe visto guarda solo i sorgenti PHP: **64 chiavi su 393**. Due punti, e l'ordine è il contenuto — prima il test che diventa rosso, poi le traduzioni | `TTC` | media |
