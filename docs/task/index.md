...
| [./todo/20260819-frontend-complexity/](./todo/20260819-frontend-complexity/) | Tre rilievi `high` di complessità cognitiva nel frontend (`usePassword`, due `submit`). Il vincolo non è la complessità: **in questo repository non c'è nulla che esegua JavaScript**. E leggendo quelle funzioni è uscito `VDF22`, un errore in esercizio | `TFC` | media |
