...
| ~~TCC15~~ | **spostato** (2026-08-12) | La rinomina del database di sviluppo e la creazione di `idp_develop` sono confluite in [local-environments](../20260812-local-environments/action-plan.md) come `TLE01`, insieme alla decisione su quale database usa la suite. Qui non resta niente da fare | — | — | — | — |
