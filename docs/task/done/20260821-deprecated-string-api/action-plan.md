...
| TDS04 | **chiuso dal developer** (2026-08-21) | La conferma dal report: i tre rilievi non compaiono più. **Il report l'ha guardato il developer**, non l'agente — è l'unico punto del lotto senza un comando che lo dimostri, e va detto | nessuno (verifica) | basso | man | il developer ha confermato dopo aver letto il report |
